    ...
    >
      ...
      <ul class="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
        <li class="items-center">
          <a
          class="text-xs uppercase py-3 font-bold block {location.href.indexOf('/page/system_management/register') !== -1 ? 'text-pink-500 hover:text-pink-600':'text-blueGray-700 hover:text-blueGray-500'}"
            href="/page/system_management/register"
          >
        ...
        <li class="items-center">
          <a
          class="text-xs uppercase py-3 font-bold block {location.href.indexOf('/admin/dashboard') !== -1 ? 'text-pink-500 hover:text-pink-600':'text-blueGray-700 hover:text-blueGray-500'}"
            href="/profile"
          >
      ...
      <ul class="md:flex-col md:min-w-full flex flex-col list-none">
        ...
        <li class="items-center">
          <a
            href="/admin/settings"
            class="text-xs uppercase py-3 font-bold block {location.href.indexOf('/admin/settings') !== -1 ? 'text-pink-500 hover:text-pink-600':'text-blueGray-700 hover:text-blueGray-500'}"
          >
            <i
        ...
        <li class="items-center">
          <a
            href="/admin/tables"
            class="text-xs uppercase py-3 font-bold block {location.href.indexOf('/admin/tables') !== -1 ? 'text-pink-500 hover:text-pink-600':'text-blueGray-700 hover:text-blueGray-500'}"
          >
            <i
        ...
        <li class="items-center">
          <a
            href="/admin/maps"
            class="text-xs uppercase py-3 font-bold block {location.href.indexOf('/admin/maps') !== -1 ? 'text-pink-500 hover:text-pink-600':'text-blueGray-700 hover:text-blueGray-500'}"
          >
            <i
